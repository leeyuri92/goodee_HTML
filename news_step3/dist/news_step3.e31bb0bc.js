...
var ul = document.createElement('ul'); // <ul>이 만들어 진다. DOM API 가지고 태그를 만드니까 직관적이지 않다. DOM Tree 그려지지 않아서
...
for (var i = 0; i < 5; i++) {
  ...
  div.innerHTML = "  \n  <li>\n    <a href=\"#".concat(newsList[i].id, "\">\n      ").concat(newsList[i].title, "(\u2764\uFE0F").concat(newsList[i].comments_count, ")\n    </a>\n  </li>\n");
